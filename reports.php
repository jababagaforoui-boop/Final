...
body.dark .confirmed:hover,
body.dark .rejected:hover{opacity:0.85; transition:0.2s;}

/* FORM ELEMENTS */
textarea, select{width:100%;padding:8px;margin-bottom:5px;border-radius:6px;border:1px solid #ccc;}
button{padding:8px 12px;background:#38b000;color:#fff;border:none;border-radius:6px;cursor:pointer;}
button:hover{background:#2d6a4f;}
body.dark textarea, body.dark select{background:#2d3748;color:#f8f8f8;border:1px solid #555;}
...
<div class="header">
    <div>
        ...
        <?php if(isset($success_reply)) echo '<p style="color:green;">'.$success_reply.'</p>'; ?>
        <?php if(isset($error_reply)) echo '<p style="color:red;">'.$error_reply.'</p>'; ?>
    </div>
